...
<head>
    ...
    <link rel="stylesheet" href="./css/event-overview.css">
...
<body>
    ...
    <div class="content">
        ...
        <div class="event-wrapper">
            <div class="event-info">
                ...
                <p style="color: red; font-style: italic; font-size: 14px;">Remember to also consult with your local health organizations for additional guidelines.</p>
    ...
    <script src="./js/event-overview.js"></script>
    <script>
