            ...
            <?php 
                if (isset($results) && count($results) > 0) {
                    ...
                    foreach ($results as $res) {
                        ...
                        echo "Start Date: ".$start[0]." - ".$end[0]."<br>";
                        echo "<div style='display: inline-block;'>";
                        if ($res['reqs']['facemasks'] == "true") {
                            echo "<img style='width: 40px; height: 40px; margin-top: 3px; margin-right: 4px;' src='./res/emoji_mask.png' title='Face masks recommended' alt='Face masks recommended'>";
                        }
                        if ($res['reqs']['sanitizer'] == "true") {
                            echo "<img style='width: 40px; height: 40px; margin-top: 3px; margin-right: 4px;' class='icon' src='./res/hand_santizer.png' title='Hand sanitizer stations present' alt='Hand sanitizer stations present'>";
                        } 
                        if ($res['reqs']['tempcheck'] == "true") {
                            echo "<img style='width: 40px; height: 40px; margin-top: 3px; margin-right: 4px;' class='icon' src='./res/temperature_check.png' title='Temperature checks conducted' alt='Temperature checks conducted'>";
                        } 
                        if ($res['reqs']['inoroutdoor'] == "ind") {
                            echo "<img style='width: 40px; height: 40px; margin-top: 3px; margin-right: 4px;' class='icon' src='./res/inside.png' title='Inside event' alt='Inside event'>";
                        } else if ($res['reqs']['inoroutdoor'] == "out") {
                            echo "<img style='width: 40px; height: 40px; margin-top: 3px; margin-right: 4px;' src='./res/outdoor.png' title='Outdoor event' alt='Outdoor event'>";
                        } else if ($res['reqs']['inoroutdoor'] == "mix") {
                            echo "<img style='width: 40px; height: 40px; margin-top: 3px; margin-right: 4px;' class='icon' src='./res/mixed.png' title='Both indoor & outdoor event' alt='Both indoor & outdoor event'>";
                        } 
                        if ($res['reqs']['notrecage'] == "false") {
                            echo "<img style='width: 40px; height: 40px; margin-top: 3px; margin-right: 4px;' class='icon' src='./res/old_man.png' title='Recommended for age 65+' alt='Recommended for age 65+'>";
                        } 
                        if ($res['reqs']['caplimit'] == "lrg") {
                            echo "<img style='width: 40px; height: 40px; margin-top: 3px; margin-right: 4px;' class='icon' src='./res/over100.png' title='Estimated attendance over 100' alt='Estimated attendance over 100'>";
                        } else if ($res['reqs']['caplimit'] == "med") {
                            echo "<img style='width: 40px; height: 40px; margin-top: 3px; margin-right: 4px;' class='icon' src='./res/50-100.png' title='Estimated attendance between 50-100' alt='Estimated attendance between 50-100'>";
                        } else if ($res['reqs']['caplimit'] == "sml") {
                            echo "<img style='width: 40px; height: 40px; margin-top: 3px; margin-right: 4px;' class='icon' src='./res/less50.png' title='Estimated attendance up to 50' alt='Estimated attendance up to 50'>";
                        }
                        echo "</div>";
                        echo "</li>";
                    }
                    ...
                    echo "<div style='font-size: 20px;'>No search results found. Try searching for something else on the left!</div>";
                }
            ?>
