    ...
    <form enctype="multipart/form-data" action="./create-event.php" method="POST">
        ...
        <div class="event-wrapper">
            <div class="event-info">
                    ...
                    <div id="event-date-input" class="col-xs-2">Date: <input type="date" class="date-input" name="startdate" id="date1" placeholder="mm-dd-yyyy" <?php echo "value='".$eventdata['startdate']."'"; ?> required> - <input type="date" class="date-input" name="enddate" id="date2" placeholder="mm-dd-yyyy" <?php echo "value='".$eventdata['enddate']."'"; ?> required></div>
